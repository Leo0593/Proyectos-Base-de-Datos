...
Public Class Ingresos
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles INGRESOS_FIJOS.Click
        Try
            ...
            Else
                ...
                If Double.TryParse(INS_CANTIDAD.Text, cantidad) Then
                    Dim comandos As New MySqlCommand("INSERT INTO `ingresos__fijos`(Cantidad, Descripcion, Fecha) VALUES (@cantidad, @descripcion, @fecha)", conexion)
    ...
    Private Sub Button1_Click_1(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            ...
            Else
                Dim cantidad As Double
                If Double.TryParse(INS_CANTIDAD.Text, cantidad) Then
                    Dim comandos As New MySqlCommand("INSERT INTO `ingresos__variables`(Cantidad, Descripcion, Fecha) VALUES (@cantidad, @descripcion, @fecha)", conexion)
                    comandos.Parameters.AddWithValue("@cantidad", cantidad)
                    comandos.Parameters.AddWithValue("@descripcion", INS_DESCRIPCION.Text)
