...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-12-2023 a las 15:02:02
...
(1, 1, 1, 1, 'arroz', '2022-12-17', '2027-08-19', 'Buen estado', 9),
(2, 1, 1, 1, 'arroz', '2022-12-17', '2027-08-19', 'Buen estado', 9),
(3, 2, 1, 1, 'arroz', '2022-12-17', '2027-08-19', 'Buen estado', 9),
(4, 2, 1, 1, 'arroz', '2022-12-17', '2027-08-19', 'Buen estado', 9),
(5, 3, 1, 2, 'atun', '2022-12-17', '2028-08-19', 'Buen estado', 10),
(6, 3, 1, 2, 'atun', '2022-12-17', '2028-08-19', 'Buen estado', 10),
(7, 4, 1, 1, 'leche en polvo', '2022-12-17', '2032-08-19', 'Buen estado', 10),
(8, 4, 1, 1, 'leche en polvo', '2022-12-17', '2032-08-19', 'Buen estado', 10),
(9, 5, 1, 1, 'sal', '2022-12-17', '2050-08-19', 'Buen estado', 10),
(10, 5, 1, 1, 'sal', '2022-12-17', '2050-08-19', 'Buen estado', 10);
...
(2, 'Martín', 'Rodríguez', 'Y1915073S', 620638618, 'Plaça de Manuel Bertrand', 1, 'Mollerusa'),
(3, 'Javier', 'Martínez', 'Z1136488V', 698261330, 'Carrer de Domènec Cardenal, 1', 1, 'Mollerusa'),
(4, 'Juan', 'López', 'X6163089D', 780935658, 'Avinguda de Jaume I, 1', 1, 'Mollerusa'),
(5, 'Carlos', 'Sánchez', 'X4069220Z', 793999576, 'Carrer Joan Maragall, 2', 1, 'Mollerusa'),
(6, 'Diego', 'Pérez', 'X4489203V', 685821074, 'Carrer de Sidamon, 8', 1, 'Mollerusa'),
(7, 'Andrés', 'Fernández', 'Z5218639J', 680571488, 'Carrer de Fondarella, 20', 1, 'Mollerusa'),
(8, 'Luis', 'González', 'Y6261841J', 618126308, 'Carrer de Canàries, 11', 1, 'Mollerusa'),
(9, 'Jorge', 'Ramírez', 'Z8494369Z', 613447080, 'Avinguda de Jaume I, 32', 1, 'Mollerusa'),
(10, 'Gabriel', 'Díaz', 'Z2426181P', 732652162, 'Avinguda del President Macià', 1, 'Mollerusa'),
(11, 'Ana', 'Hernández', 'Y7731704S', 719313404, 'Ctra. de Torregrossa', 1, 'Mollerusa'),
(12, 'María', 'Gómez', 'X9944741R', 723486901, 'Carrer del Germà Jaume Hilari', 1, 'Mollerusa'),
(13, 'Laura', 'Jiménez', 'X6368057R', 727198001, 'Ctra. Torregrossa, 20-46', 1, 'Mollerusa'),
(14, 'Carolina', 'Torres', 'X4375786J', 662635507, 'Carrer del Germà Jaume Hilari, 11', 1, 'Mollerusa'),
(15, 'Isabel', 'Vargas', 'Y8277410T', 603106818, 'LV-2001, 37', 1, 'Mollerusa'),
(16, 'Paula', 'Ruiz', 'X6941974E', 788147774, 'Carrer Toni Castellseguer, 9', 1, 'Mollerusa'),
(17, 'Gabriela', 'Castro', 'X7311518W', 651, 'Carrer Pol. Ind. Tumsa, 29', 1, 'Mollerusa');
